...
function createNodeResolver(_a = {}) {
  ...
  const resolver = new unrsResolver.ResolverFactory(__spreadValues$f({
    extensions,
    conditionNames,
    mainFields
  }, restOptions));
...
function parse(path2, content, context) {
  ...
  parserOptions = __spreadValues$e({}, parserOptions);
  parserOptions.ecmaFeatures = __spreadValues$e({}, parserOptions.ecmaFeatures);
...
class ModuleCache {
  ...
  static getSettings(settings) {
    const cacheSettings = __spreadValues$d({
      lifetime: 30
...
var __publicField = (obj, key, value) => __defNormalProp$c(obj, typeof key !== "symbol" ? key + "" : key, value);
...
const parseComment = (comment) => {
  ...
  */`;
  ...
  return __spreadProps$6(__spreadValues$c({}, doc), {
    tags: doc.tags.map(
      (t) => t.name && fixup.has(t.tag) ? __spreadProps$6(__spreadValues$c({}, t), { description: `${t.name} ${t.description}` }) : t
    )
  });
};
class ExportMap {
...
function moduleVisitor(visitor, options) {
  ...
  const esmodule = !!__spreadValues$b({ esmodule: true }, options).esmodule;
...
const parsePath = (path) => {
  ...
  const query = hasQuery ? path.slice(queryIndex, hasHash ? hashIndex : void 0) : "";
  const pathname = hasQuery ? path.slice(0, queryIndex) : hasHash ? path.slice(0, hashIndex) : path;
...
function computeOverrideAction(pathGroupOverrides, path2) {
  for (const { pattern, patternOptions, action } of pathGroupOverrides) {
    if (minimatch.minimatch(path2, pattern, patternOptions || { nocomment: true })) {
      return action;
    }
  }
}
      ...
      (source, node) => {
        ...
        if (!extension || !importPath.endsWith(`.${extension}`)) {
          ...
          if (extensionRequired && !extensionForbidden) {
            ...
            context.report(__spreadValues$a({
              node: source,
            ...
            }, extension && (props.fix ? fixOrSuggest : {
              suggest: [
                __spreadProps$5(__spreadValues$a({}, fixOrSuggest), {
          ...
          const commonSuggestion = __spreadProps$5(__spreadValues$a({}, fixOrSuggest), {
          ...
          }, props.fix ? fixOrSuggest : {
            suggest: [
              commonSuggestion,
              isIndex && __spreadProps$5(__spreadValues$a({}, commonSuggestion), {
                fix(fixer) {
                  return fixer.replaceText(
                    source,
                    replaceImportPath(
                ...
                data: __spreadProps$5(__spreadValues$a({}, commonSuggestion.data), {
